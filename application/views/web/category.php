	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
	            ...
	            <h3 class="h1 font-serif text-center text-md-left"><?=$category;?></h3>
	            
	            <div class="row my-4">
	                <div class="col-md-8 text-center text-md-left mb-4">
	                    <a href="<?=base_url()?>web/news" class="btn btn-news px-3">Semua</a>
	                ...
	                <div class="col-md-4">
	                    <div class="input-group">
	            			...
	            			<form class="secondary-search text" method="get" action="<?=base_url();?>web/search">
